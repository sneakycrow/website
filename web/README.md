...
- Email/Password Authentication
  with [cookie-based sessions](https://remix.run/utils/sessions#md-createcookiesessionstorage)
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create web-9d73
  fly apps create web-9d73-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-9d73
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-9d73-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the
  ...
  ```sh
  fly volumes create data --size 1 --app web-9d73
  fly volumes create data --size 1 --app web-9d73-staging
  ```
