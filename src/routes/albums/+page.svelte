...
<section class="lg:col-span-6 row-start-2 row-span-2 grid grid-cols-3 gap-10">
  <p class="col-span-3 text-center text-lg font-semibold">
    A collection of albums provided by Spotify
  </p>
